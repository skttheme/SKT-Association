...
<?php esc_html_e( 'Skip to content', 'skt-association' ); ?>
</a>
<?php
	...
	$headerbtnlink = esc_html(get_theme_mod('header_btnlink'));
...
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}else{if(!is_home() && $inner_header_trans == '') {echo esc_html('transheader');}}?>">	
	<div class="container">
    <div class="logo">
		<?php skt_association_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
        ...
        <div id="navigation" <?php if( $hideheaderbutton !== '') { ?>class="rightnavig"<?php } ?>><nav id="site-navigation" class="main-navigation">
            ...
            <div class="srcrt">
                <div class="header-content-right">
                    <div class="skt-header-extras">
                    	<div class="skt-header-button"><a href="<?php echo esc_url($headerbtnlink); ?>" target="_blank"><div class="hedbtn-details"><?php echo esc_html( $headerbtntext ); ?></div></a></div>
                    </div>
                </div>
            </div>
            <?php } ?>    
